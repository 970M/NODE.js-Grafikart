...
var server = http
    .createServer(
        // La méthode createServer de l'objet http permet comme son nom l'indique de créer un serveur (*)
        function (req, res) {
            // La fonction qui est passée en paramètre à createServer est celle qui sera appelée à chaque requête sur notre serveur
